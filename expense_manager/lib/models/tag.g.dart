...
extension TagQueryFilter on QueryBuilder<Tag, Tag, QFilterCondition> {
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorCodeIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorCodeIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorCodeEqualTo(
    String? value, {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorCodeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorCodeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorCodeContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorCodeMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorCodeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'colorCode',
        value: '',
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> colorCodeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'colorCode',
        value: '',
...
extension TagQueryLinks on QueryBuilder<Tag, Tag, QFilterCondition> {
  QueryBuilder<Tag, Tag, QAfterFilterCondition> expenses(
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> expensesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> expensesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'expenses', 0, true, 0, true);
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> expensesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'expenses', 0, false, 999999, true);
    });
  }

  QueryBuilder<Tag, Tag, QAfterFilterCondition> expensesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> expensesLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Tag, Tag, QAfterFilterCondition> expensesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TagQueryProperty on QueryBuilder<Tag, Tag, QQueryProperty> {
  ...
  QueryBuilder<Tag, String?, QQueryOperations> colorCodeProperty() {
    return QueryBuilder.apply(this, (query) {
...
Tag _$TagFromJson(Map<String, dynamic> json) => Tag()
  ...
  ..isFromRemark = json['isFromRemark'] as bool
...
Map<String, dynamic> _$TagToJson(Tag instance) => <String, dynamic>{
      ...
      'isFromRemark': instance.isFromRemark,
